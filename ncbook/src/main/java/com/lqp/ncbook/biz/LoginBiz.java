package com.lqp.ncbook.biz;

import com.lqp.ncbook.model.Ticket;
import com.lqp.ncbook.model.User;
import com.lqp.ncbook.model.exceptions.LoginRegisterException;
...
import com.lqp.ncbook.utils.MD5;
import com.lqp.ncbook.utils.TicketUtils;
...
public class LoginBiz {
    ...
    public String login(String email,String password)throws Exception
    {
        ...
        if(t.getExpiredAt().before(new Date())){
            //删除
            ticketService.delectTicket(t.getId());
        }
